...
function buildHealthPayload() {
  ...
  return {
    ...
    data: {
      ...
      emailProviders: env.emailProviders || [],
      smtpEnabled: env.smtpEnabled,
      resendEnabled: env.resendEnabled,
      ...
      notificationEveningHour: env.notificationEveningHour,
      deliveryWorkerEnabled: env.deliveryWorkerEnabled,
      notificationEmailMode: 'event-and-scheduled',
