...
export default function AppShell() {
  ...
  return (
    <div className="min-h-screen bg-background vignette relative overflow-hidden">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,hsl(0_55%_33%_/_0.14),transparent_26%),radial-gradient(circle_at_90%_15%,hsl(38_40%_38%_/_0.08),transparent_25%)]" />
      ...
      <div className="relative z-10 flex min-h-screen w-full">
        ...
        <main className="min-w-0 flex-1">
          ...
          <div className="w-full min-w-0 px-4 pb-10 pt-6 md:px-8 xl:px-10">
